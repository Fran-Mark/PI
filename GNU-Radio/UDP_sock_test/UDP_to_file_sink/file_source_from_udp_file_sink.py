...
class file_source_from_udp_file_sink(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "file_source_from_udp_file_sink")
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_int*1, '/run/media/fran/46FAA90DFAA8FA77/Ventanas/IB/PI/GitHub/GNU-Radio/UDP_sock_test/UDP_to_file_sink/file_py', False, 0, 0)
...
def main(top_block_cls=file_source_from_udp_file_sink, options=None):
