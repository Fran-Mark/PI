...
class maint(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, '/run/media/fran/46FAA90DFAA8FA77/Ventanas/IB/PI/GitHub/GNU-Radio/DDS_emulator/data/señal_bin/signal', False)
        self.blocks_file_sink_0.set_unbuffered(False)
        self.beamforming_doaesprit_py_cf_0 = beamforming.doaesprit_py_cf(2, 2, fc, 0.55*299792458/fc, 1, 128)
        ...
        self.connect((self.beamforming_beamformer_0, 0), (self.blocks_file_sink_0, 0))
        self.connect((self.beamforming_beamformer_0, 0), (self.blocks_null_sink_0_0, 0))
        self.connect((self.beamforming_beamformer_0, 0), (self.qtgui_freq_sink_x_0, 0))
