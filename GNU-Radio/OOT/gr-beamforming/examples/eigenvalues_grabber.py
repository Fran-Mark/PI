...
class eigenvalues_grabber(gr.top_block):
    ...
    def __init__(self, const_1_name="BPSK", const_2_name="QPSK", const_3_name="BPSK", const_4_name="QPSK", const_5_name="BPSK", const_6_name="QPSK", const_7_name="BPSK", const_8_name="QPSK", element_separation=0, file_name="eigenvalues5.csv", noise_voltage_1=0, noise_voltage_2=0, noise_voltage_3=0, noise_voltage_4=0, noise_voltage_5=0, noise_voltage_6=0, noise_voltage_7=0, noise_voltage_8=0, phi_1=70, phi_2=41, phi_3=70, phi_4=41, phi_5=70, phi_6=41, phi_7=70, phi_8=41, theta_1=45, theta_2=75, theta_3=45, theta_4=75, theta_5=45, theta_6=75, theta_7=45, theta_8=75):
        ...
        # Blocks
        ##################################################
        self.digital_chunks_to_symbols_xx_0_0_0_0 = digital.chunks_to_symbols_bc(const_4.points(), 1)
        self.digital_chunks_to_symbols_xx_0_0_0 = digital.chunks_to_symbols_bc(const_3.points(), 1)
        ...
        self.blocks_packed_to_unpacked_xx_0_0_0_0 = blocks.packed_to_unpacked_bb(bps_4, gr.GR_MSB_FIRST)
        self.blocks_packed_to_unpacked_xx_0_0_0 = blocks.packed_to_unpacked_bb(bps_3, gr.GR_MSB_FIRST)
        ...
        self.beamforming_phasedarray_0_0_0_0 = beamforming.phasedarray(mx, my, theta_4, phi_4, 436e6, (299792458/(2*fc)), element_separation)
        self.beamforming_phasedarray_0_0_0 = beamforming.phasedarray(mx, my, theta_3, phi_3, 436e6, (299792458/(2*fc)), element_separation)
        ...
        self.analog_vectornoise_source_0_1 = analog.vectornoise_source(noise_voltage_3, mx*my)
        self.analog_vectornoise_source_0_0_0 = analog.vectornoise_source(noise_voltage_4, mx*my)
        ...
        self.analog_random_source_x_0_0_0_0 = blocks.vector_source_b(list(map(int, numpy.random.randint(0, 256, 10000))), False)
        self.analog_random_source_x_0_0_0 = blocks.vector_source_b(list(map(int, numpy.random.randint(0, 256, 10000))), False)
        self.analog_random_source_x_0_0 = blocks.vector_source_b(list(map(int, numpy.random.randint(0, 256, 10000))), False)
        self.analog_random_source_x_0 = blocks.vector_source_b(list(map(int, numpy.random.randint(0, 256, 10000))), False)
        ...
        self.connect((self.analog_vectornoise_source_0_0_0, 0), (self.blocks_add_xx_0_0_0, 1))
        self.connect((self.analog_vectornoise_source_0_1, 0), (self.blocks_add_xx_0_1, 1))
        ...
        self.connect((self.beamforming_phasedarray_0_0_0, 0), (self.blocks_add_xx_0_1, 0))
        self.connect((self.beamforming_phasedarray_0_0_0_0, 0), (self.blocks_add_xx_0_0_0, 0))
        ...
        self.connect((self.blocks_add_xx_1_0_0_0_0_0, 0), (self.beamforming_randomsampler_0, 0))
        ...
        self.connect((self.blocks_packed_to_unpacked_xx_0_0_0_0, 0), (self.digital_chunks_to_symbols_xx_0_0_0_0, 0))
        ...
        self.connect((self.blocks_throttle_0_0_0, 0), (self.blocks_packed_to_unpacked_xx_0_0_0, 0))
        self.connect((self.blocks_throttle_0_0_0_0, 0), (self.blocks_packed_to_unpacked_xx_0_0_0_0, 0))
        ...
        self.connect((self.digital_chunks_to_symbols_xx_0_0_0, 0), (self.beamforming_phasedarray_0_0_0, 0))
        self.connect((self.digital_chunks_to_symbols_xx_0_0_0_0, 0), (self.beamforming_phasedarray_0_0_0_0, 0))
...
def argument_parser():
    ...
    parser.add_argument(
        "--const-1-name", dest="const_1_name", type=str, default="BPSK",
        help="Set const_1_name [default=%(default)r]")
    parser.add_argument(
        "--const-2-name", dest="const_2_name", type=str, default="QPSK",
        help="Set const_2_name [default=%(default)r]")
    parser.add_argument(
        "--const-3-name", dest="const_3_name", type=str, default="BPSK",
        help="Set const_3_name [default=%(default)r]")
    parser.add_argument(
        "--const-4-name", dest="const_4_name", type=str, default="QPSK",
        help="Set const_4_name [default=%(default)r]")
    parser.add_argument(
        "--const-5-name", dest="const_5_name", type=str, default="BPSK",
        help="Set const_5_name [default=%(default)r]")
    parser.add_argument(
        "--const-6-name", dest="const_6_name", type=str, default="QPSK",
        help="Set const_6_name [default=%(default)r]")
    parser.add_argument(
        "--const-7-name", dest="const_7_name", type=str, default="BPSK",
        help="Set const_7_name [default=%(default)r]")
    parser.add_argument(
        "--const-8-name", dest="const_8_name", type=str, default="QPSK",
        help="Set const_8_name [default=%(default)r]")
    parser.add_argument(
        "--file-name", dest="file_name", type=str, default="eigenvalues5.csv",
    ...
    parser.add_argument(
        "--phi-3", dest="phi_3", type=eng_float, default="70.0",
        help="Set Azimut Angle 3 [default=%(default)r]")
    parser.add_argument(
        "--phi-4", dest="phi_4", type=eng_float, default="41.0",
        help="Set Azimut Angle 4 [default=%(default)r]")
    parser.add_argument(
        "--phi-5", dest="phi_5", type=eng_float, default="70.0",
        help="Set Azimut Angle 5 [default=%(default)r]")
    parser.add_argument(
        "--phi-6", dest="phi_6", type=eng_float, default="41.0",
        help="Set Azimut Angle 6 [default=%(default)r]")
    parser.add_argument(
        "--phi-7", dest="phi_7", type=eng_float, default="70.0",
        help="Set Azimut Angle 7 [default=%(default)r]")
    parser.add_argument(
        "--phi-8", dest="phi_8", type=eng_float, default="41.0",
    ...
    parser.add_argument(
        "--theta-3", dest="theta_3", type=eng_float, default="45.0",
        help="Set Elevation Angle 3 [default=%(default)r]")
    parser.add_argument(
        "--theta-4", dest="theta_4", type=eng_float, default="75.0",
        help="Set Elevation Angle 4 [default=%(default)r]")
    parser.add_argument(
        "--theta-5", dest="theta_5", type=eng_float, default="45.0",
        help="Set Elevation Angle 5 [default=%(default)r]")
    parser.add_argument(
        "--theta-6", dest="theta_6", type=eng_float, default="75.0",
        help="Set Elevation Angle 6 [default=%(default)r]")
    parser.add_argument(
        "--theta-7", dest="theta_7", type=eng_float, default="45.0",
        help="Set Elevation Angle 7 [default=%(default)r]")
    parser.add_argument(
        "--theta-8", dest="theta_8", type=eng_float, default="75.0",
...
def main(top_block_cls=eigenvalues_grabber, options=None):
    ...
    tb = top_block_cls(const_1_name=options.const_1_name, const_2_name=options.const_2_name, const_3_name=options.const_3_name, const_4_name=options.const_4_name, const_5_name=options.const_5_name, const_6_name=options.const_6_name, const_7_name=options.const_7_name, const_8_name=options.const_8_name, file_name=options.file_name, phi_1=options.phi_1, phi_2=options.phi_2, phi_3=options.phi_3, phi_4=options.phi_4, phi_5=options.phi_5, phi_6=options.phi_6, phi_7=options.phi_7, phi_8=options.phi_8, theta_1=options.theta_1, theta_2=options.theta_2, theta_3=options.theta_3, theta_4=options.theta_4, theta_5=options.theta_5, theta_6=options.theta_6, theta_7=options.theta_7, theta_8=options.theta_8)
