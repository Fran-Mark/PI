...
class contador(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "contador")
        ...
        # Blocks
        ##################################################
        self.stream_demux_stream_demux_1 = stream_demux_swig.stream_demux(gr.sizeof_gr_complex*1, (1, 15))
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_short*1, '/run/media/fran/46FAA90DFAA8FA77/Ventanas/IB/PI/GitHub/GNU-Radio/DDS_emulator/udp_to_filesink/ignore/contador', True, 0, 0)
        ...
        self.connect((self.blocks_throttle_0, 0), (self.stream_demux_stream_demux_0, 0))
        ...
        self.connect((self.stream_demux_stream_demux_1, 0), (self.qtgui_time_sink_x_0_0, 0))
...
def main(top_block_cls=contador, options=None):
