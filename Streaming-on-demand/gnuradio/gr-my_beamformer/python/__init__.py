...
'''
This is the GNU Radio MY_BEAMFORMER module. Place your Python package
...
# import swig generated symbols into the my_beamformer namespace
try:
    # this might fail if the module is python-only
    from .my_beamformer_swig import *
