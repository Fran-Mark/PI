...
#
# test.tcl: Tcl script for re-creating project 'leds_test'
#
# Generated by Vivado on Tue Dec 07 15:35:05 -03 2021
...
#
#    "/media/fran/46FAA90DFAA8FA77/Ventanas/IB/PI/GitHub/Fpga/prj/test/src/led_blinker.vhd"
#    "/media/fran/46FAA90DFAA8FA77/Ventanas/IB/PI/GitHub/Fpga/prj/test/src/leds_constraints.xdc"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  ...
  set files [list \
   "/media/fran/46FAA90DFAA8FA77/Ventanas/IB/PI/GitHub/Fpga/prj/test/src/led_blinker.vhd" \
   "/media/fran/46FAA90DFAA8FA77/Ventanas/IB/PI/GitHub/Fpga/prj/test/constraints/leds_constraints.xdc" \
  ]
  foreach ifile $files {
...
set orig_proj_dir "[file normalize "$origin_dir/vivado/leds_test"]"
...
set files [list \
 [file normalize "${origin_dir}/src/led_blinker.vhd"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/src/led_blinker.vhd"
...
if { [get_files led_blinker.vhd] == "" } {
  import_files -quiet -fileset sources_1 /media/fran/46FAA90DFAA8FA77/Ventanas/IB/PI/GitHub/Fpga/prj/test/src/led_blinker.vhd
}
...
# led_blinker
  ...
  connect_bd_net -net Net [get_bd_pins led_blinker_0/clk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK]
  connect_bd_net -net led_blinker_0_leds [get_bd_ports leds_0] [get_bd_pins led_blinker_0/leds]
  connect_bd_net -net led_blinker_0_vadj_en [get_bd_ports vadj_en_0] [get_bd_pins led_blinker_0/vadj_en]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins led_blinker_0/syn_clr] [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins processing_system7_0/FCLK_RESET0_N]
...
if { [get_property IS_LOCKED [ get_files -norecurse design_1.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/vivado/leds_test/leds_test.gen/sources_1/bd/design_1/hdl/design_1_wrapper.vhd" ]
} else {
