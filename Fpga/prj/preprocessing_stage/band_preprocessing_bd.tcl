...
proc create_hier_cell_Band_filter_hier { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.Coefficient_File {C:\Ventanas\IB\PI\GitHub\Fpga\prj\preprocessing_stage\filters\bandpass.coe} \
...
proc create_root_design { parentCell } {
  ...
  # Create port connections
  connect_bd_net -net Band_filter_hier_m_axis_data_tdata [get_bd_ports m_axis_tdata] [get_bd_pins Band_filter_hier/m_axis_data_tdata]
  connect_bd_net -net Band_filter_hier_m_axis_data_tvalid [get_bd_ports m_axis_tvalid] [get_bd_pins Band_filter_hier/m_axis_data_tvalid]
  ...
  connect_bd_net -net s_axis_a_tdata_0_1 [get_bd_ports s_axis_a_tdata_0] [get_bd_pins Band_mixer/s_axis_a_tdata]
  connect_bd_net -net s_axis_a_tvalid_0_1 [get_bd_ports s_axis_a_tvalid_0] [get_bd_pins Band_mixer/s_axis_a_tvalid] [get_bd_pins Band_mixer/s_axis_b_tvalid]
  connect_bd_net -net s_axis_b_tdata_0_1 [get_bd_ports s_axis_b_tdata_0] [get_bd_pins Band_mixer/s_axis_b_tdata]
