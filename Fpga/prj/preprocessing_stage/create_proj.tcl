...
#
# Generated by Vivado on Thu Aug 25 16:39:35 -0700 2022
...
if { [get_files resizer.vhd] == "" } {
  import_files -quiet -fileset sources_1 C:/Ventanas/IB/PI/GitHub/Fpga/prj/preprocessing_stage/src/helpers/resizer.vhd
}
...
# module references:
# dsp_dds_compiler_controller, dsp_dds_compiler_controller, dsp_dds_compiler_controller, axi_slave_reg, basic_counter, dsp_data_source_mux, resizer, subarray_creator, zero_padder
  ...
  set_property -dict [ list \
   ...
   CONFIG.Output_Frequency1 {74} \
   CONFIG.Output_Width {8} \
   CONFIG.PINC1 {10010001101110010001101110010} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.Output_Width {8} \
   CONFIG.PINC1 {111111000000111111000000} \
   CONFIG.Parameter_Entry {System_Parameters} \
   CONFIG.Phase_Increment {Fixed} \
   CONFIG.Phase_Width {30} \
   CONFIG.S_PHASE_Has_TUSER {Not_Required} \
  ...
  connect_bd_net -net aclk_0_1 [get_bd_ports adc_clk] [get_bd_pins Band_filter/aclk] [get_bd_pins Band_mixer/aclk] [get_bd_pins Band_selector_oscillator/aclk] [get_bd_pins Band_selector_oscillator_controller/aclk] [get_bd_pins Channel_filter/aclk] [get_bd_pins Channel_mixer/aclk] [get_bd_pins Channel_selector_oscillator/aclk] [get_bd_pins Channel_selector_oscillator_controller/aclk] [get_bd_pins Local_oscillator/aclk] [get_bd_pins Oscillator_controller/aclk] [get_bd_pins basic_counter_0/clk_i]
  ...
  connect_bd_net -net data_in_0_1 [get_bd_ports data_in_0] [get_bd_pins resizer_0/data_in]
  ...
  connect_bd_net -net dsp_data_source_mux_0_m_axis_tvalid [get_bd_pins Band_mixer/s_axis_a_tvalid] [get_bd_pins dsp_data_source_mux_0/m_axis_tvalid]
  connect_bd_net -net resizer_0_data_out [get_bd_pins dsp_data_source_mux_0/adc_tdata] [get_bd_pins resizer_0/data_out]
  connect_bd_net -net rst_ni_0_1 [get_bd_ports adc_rst_ni] [get_bd_pins Band_mixer/aresetn] [get_bd_pins Band_selector_oscillator_controller/rst_ni] [get_bd_pins Channel_mixer/aresetn] [get_bd_pins Channel_selector_oscillator_controller/rst_ni] [get_bd_pins Oscillator_controller/rst_ni] [get_bd_pins basic_counter_0/rst_ni]
  ...
  connect_bd_net -net zero_padder_0_data_out [get_bd_pins Band_mixer/s_axis_a_tdata] [get_bd_pins zero_padder_0/data_out]
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"0.806576",
   "Default View_TopLeft":"2048,0",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r6  2020-01-29 bk=1.5227 VDI=41 GEI=36 GUI=JA:10.0 non-TLS
#  -string -flagsOSRD
preplace port S00_AXI_0 -pg 1 -lvl 0 -x -20 -y 300 -defaultsOSRD
preplace port adc_tvalid_0 -pg 1 -lvl 0 -x -20 -y 120 -defaultsOSRD
preplace port adc_clk -pg 1 -lvl 0 -x -20 -y 180 -defaultsOSRD
preplace port AXI_CLK -pg 1 -lvl 0 -x -20 -y 690 -defaultsOSRD
preplace port AXI_ARESETN -pg 1 -lvl 0 -x -20 -y 720 -defaultsOSRD
preplace port adc_rst_ni -pg 1 -lvl 0 -x -20 -y 220 -defaultsOSRD
preplace portBus data_in_0 -pg 1 -lvl 0 -x -20 -y 60 -defaultsOSRD
preplace inst Band_mixer -pg 1 -lvl 5 -x 1720 -y 350 -defaultsOSRD
preplace inst Band_filter -pg 1 -lvl 6 -x 2130 -y 340 -defaultsOSRD
preplace inst Channel_mixer -pg 1 -lvl 7 -x 2530 -y 500 -defaultsOSRD
preplace inst Channel_filter -pg 1 -lvl 9 -x 3230 -y 700 -defaultsOSRD
preplace inst subarray_creator_0 -pg 1 -lvl 8 -x 2880 -y 700 -defaultsOSRD
preplace inst Band_selector_oscillator -pg 1 -lvl 3 -x 1030 -y 320 -defaultsOSRD
preplace inst basic_counter_0 -pg 1 -lvl 2 -x 660 -y 350 -defaultsOSRD
preplace inst Channel_selector_oscillator -pg 1 -lvl 5 -x 1720 -y 520 -defaultsOSRD
preplace inst dsp_data_source_mux_0 -pg 1 -lvl 3 -x 1030 -y 170 -defaultsOSRD
preplace inst Local_oscillator -pg 1 -lvl 1 -x 330 -y 180 -defaultsOSRD
preplace inst Channel_selector_oscillator_controller -pg 1 -lvl 6 -x 2130 -y 500 -defaultsOSRD
preplace inst Band_selector_oscillator_controller -pg 1 -lvl 4 -x 1360 -y 340 -defaultsOSRD
preplace inst Oscillator_controller -pg 1 -lvl 2 -x 660 -y 200 -defaultsOSRD
preplace inst resizer_0 -pg 1 -lvl 2 -x 660 -y 60 -defaultsOSRD
preplace inst zero_padder_0 -pg 1 -lvl 4 -x 1360 -y 170 -defaultsOSRD
preplace inst axi_slave_reg_0 -pg 1 -lvl 2 -x 660 -y 570 -defaultsOSRD
preplace inst axi_interconnect_0 -pg 1 -lvl 1 -x 330 -y 360 -defaultsOSRD
preplace netloc Channel_mixer_m_axis_dout_tdata 1 7 1 2730 500n
preplace netloc Channel_mixer_m_axis_dout_tvalid 1 7 1 2720 520n
preplace netloc subarray_creator_0_tdata_out 1 8 1 N 690
preplace netloc subarray_creator_0_tvalid_out 1 8 1 N 710
preplace netloc adc_tvalid_0_1 1 0 3 0J 110 490J 120 830J
preplace netloc resizer_0_data_out 1 2 1 850J 60n
preplace netloc data_in_0_1 1 0 2 NJ 60 NJ
preplace netloc Band_mixer_m_axis_dout_tdata 1 5 1 1910 330n
preplace netloc Band_mixer_m_axis_dout_tvalid 1 5 1 1920 350n
preplace netloc dsp_data_source_mux_0_m_axis_tdata 1 3 1 NJ 170
preplace netloc zero_padder_0_data_out 1 4 1 1520 170n
preplace netloc dsp_data_source_mux_0_m_axis_tvalid 1 3 2 1210J 230 1500
preplace netloc Band_filter_m_axis_data_tdata 1 6 1 2340 340n
preplace netloc Band_filter_m_axis_data_tvalid 1 6 1 2320 360n
preplace netloc Channel_selector_oscillator_controller_m_axis_tdata 1 6 1 N 510
preplace netloc axi_slave_reg_0_data_source_selector 1 2 1 850 220n
preplace netloc aclk_0_1 1 0 9 20J 240 490 280 830 380 1210 260 1530 220 1930 250 2330 630 NJ 630 3030
preplace netloc ACLK_0_2 1 0 2 0J 570 N
preplace netloc ARESETN_0_1 1 0 2 20J 590 N
preplace netloc rst_ni_0_1 1 0 7 10J 120 480J 420 N 420 1220 420 1510 210 1940 580 2340
preplace netloc axi_interconnect_0_M00_AXI 1 1 1 470 360n
preplace netloc Band_selector_m_axis 1 4 1 N 340
preplace netloc Oscilador_local_M_AXIS_DATA_2 1 1 1 NJ 180
preplace netloc basic_counter_0_m_axis 1 2 1 840 180n
preplace netloc Oscillator_controller_m_axis 1 2 1 N 200
preplace netloc Oscilador_local_M_AXIS_DATA_1 1 5 1 1920J 480n
preplace netloc Oscilador_local_M_AXIS_DATA 1 3 1 NJ 320
preplace netloc S00_AXI_0_1 1 0 1 NJ 300
levelinfo -pg 1 -20 330 660 1030 1360 1720 2130 2530 2880 3230 3580 3740
pagesize -pg 1 -db -bbox -sgen -170 0 3740 1030
"
}
...
set_property GENERATE_SYNTH_CHECKPOINT "0" [get_files preprocessing_bd.bd ] 
