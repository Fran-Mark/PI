...
#
# Generated by Vivado on Wed Aug 17 18:40:42 -0700 2022
...
if { [get_files subarray_creator.vhd] == "" } {
  import_files -quiet -fileset sources_1 C:/Ventanas/IB/PI/GitHub/Fpga/prj/preprocessing_stage/src/helpers/subarray_creator.vhd
}
...
# module references:
# dsp_dds_compiler_controller, dsp_dds_compiler_controller, dsp_dds_compiler_controller, basic_counter, axi_slave_reg, dsp_data_source_mux, subarray_creator, zero_padder
  ...
  set_property -dict [ list \
   CONFIG.CLK_DOMAIN {preprocessing_bd_sim_clk_gen_1_0_clk} \
   CONFIG.FREQ_HZ {260000000} \
   ] $M_AXIS_DATA_0


  # Create ports
  set adc_tdata_0 [ create_bd_port -dir I -from 15 -to 0 adc_tdata_0 ]
  set adc_tvalid_0 [ create_bd_port -dir I adc_tvalid_0 ]

  # Create instance: Axi_clk, and set properties
  set Axi_clk [ create_bd_cell -type ip -vlnv xilinx.com:ip:sim_clk_gen:1.0 Axi_clk ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.Output_Frequency1 {18.5} \
   CONFIG.Output_Width {8} \
   CONFIG.PINC1 {100100011011100100011011100} \
  ...
  set_property -dict [ list \
   CONFIG.APortWidth {43} \
   CONFIG.MinimumLatency {11} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.Output_Width {8} \
   CONFIG.PINC1 {1111110000001111110000} \
   CONFIG.Parameter_Entry {System_Parameters} \
   CONFIG.Phase_Increment {Fixed} \
   CONFIG.Phase_Width {30} \
   CONFIG.S_PHASE_Has_TUSER {Not_Required} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.M_DATA_Has_TUSER {Not_Required} \
   CONFIG.Noise_Shaping {Auto} \
   CONFIG.Output_Frequency1 {19} \
   CONFIG.Output_Selection {Sine_and_Cosine} \
   CONFIG.Output_Width {8} \
   CONFIG.PINC1 {100101011010100101011010100} \
   CONFIG.Parameter_Entry {System_Parameters} \
   CONFIG.Phase_Increment {Fixed} \
   CONFIG.Phase_Width {30} \
   CONFIG.S_PHASE_Has_TUSER {Not_Required} \
  ...
  # Create instance: adc_derived_clk, and set properties
  set adc_derived_clk [ create_bd_cell -type ip -vlnv xilinx.com:ip:sim_clk_gen:1.0 adc_derived_clk ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {260000000} \
 ] $adc_derived_clk
  ...
  # Create instance: data_source_register, and set properties
  set block_name axi_slave_reg
  set block_cell_name data_source_register
  if { [catch {set data_source_register [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $data_source_register eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  # Create instance: subarray_creator_0, and set properties
  set block_name subarray_creator
  set block_cell_name subarray_creator_0
  if { [catch {set subarray_creator_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $subarray_creator_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [ list \
  ...
  connect_bd_intf_net -intf_net Band_filter_M_AXIS_DATA [get_bd_intf_pins Band_filter/M_AXIS_DATA] [get_bd_intf_pins Channel_mixer/S_AXIS_A]
  connect_bd_intf_net -intf_net Band_mixer_M_AXIS_DOUT [get_bd_intf_pins Band_filter/S_AXIS_DATA] [get_bd_intf_pins Band_mixer/M_AXIS_DOUT]
  connect_bd_intf_net -intf_net Band_selector_m_axis [get_bd_intf_pins Band_mixer/S_AXIS_B] [get_bd_intf_pins Band_selector_oscillator_controller/m_axis]
  connect_bd_intf_net -intf_net Channel_filter_M_AXIS_DATA [get_bd_intf_ports M_AXIS_DATA_0] [get_bd_intf_pins Channel_filter/M_AXIS_DATA]
  connect_bd_intf_net -intf_net Channel_selector_m_axis [get_bd_intf_pins Channel_mixer/S_AXIS_B] [get_bd_intf_pins Channel_selector_oscillator_controller/m_axis]
  ...
  connect_bd_intf_net -intf_net Oscillator_controller_m_axis [get_bd_intf_pins Oscillator_controller/m_axis] [get_bd_intf_pins dsp_data_source_mux_0/dds_compiler]
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_interconnect_0/M00_AXI] [get_bd_intf_pins data_source_register/S_AXI]
  ...
  connect_bd_intf_net -intf_net dsp_data_source_mux_0_m_axis [get_bd_intf_pins dsp_data_source_mux_0/m_axis] [get_bd_intf_pins zero_padder_0/s_axis_in]
  connect_bd_intf_net -intf_net zero_padder_0_m_axis_out [get_bd_intf_pins Band_mixer/S_AXIS_A] [get_bd_intf_pins zero_padder_0/m_axis_out]

  # Create port connections
  connect_bd_net -net Axi_clk_clk [get_bd_pins Axi_clk/clk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins data_source_register/S_AXI_ACLK]
  connect_bd_net -net Axi_clk_sync_rst [get_bd_pins Axi_clk/sync_rst] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins data_source_register/S_AXI_ARESETN]
  connect_bd_net -net Channel_mixer_m_axis_dout_tdata [get_bd_pins Channel_mixer/m_axis_dout_tdata] [get_bd_pins subarray_creator_0/tdata_in]
  connect_bd_net -net Channel_mixer_m_axis_dout_tvalid [get_bd_pins Channel_mixer/m_axis_dout_tvalid] [get_bd_pins subarray_creator_0/tvalid_in]
  connect_bd_net -net adc_derived_clk_clk [get_bd_pins Band_filter/aclk] [get_bd_pins Band_mixer/aclk] [get_bd_pins Band_selector_oscillator/aclk] [get_bd_pins Band_selector_oscillator_controller/aclk] [get_bd_pins Channel_filter/aclk] [get_bd_pins Channel_mixer/aclk] [get_bd_pins Channel_selector_oscillator/aclk] [get_bd_pins Channel_selector_oscillator_controller/aclk] [get_bd_pins Local_oscillator/aclk] [get_bd_pins Oscillator_controller/aclk] [get_bd_pins adc_derived_clk/clk] [get_bd_pins basic_counter_0/clk_i] [get_bd_pins zero_padder_0/aclk]
  connect_bd_net -net adc_derived_clk_sync_rst [get_bd_pins Band_selector_oscillator_controller/rst_ni] [get_bd_pins Channel_selector_oscillator_controller/rst_ni] [get_bd_pins Oscillator_controller/rst_ni] [get_bd_pins adc_derived_clk/sync_rst] [get_bd_pins basic_counter_0/rst_ni] [get_bd_pins zero_padder_0/rst_ni]
  connect_bd_net -net adc_tdata_0_1 [get_bd_ports adc_tdata_0] [get_bd_pins dsp_data_source_mux_0/adc_tdata]
  connect_bd_net -net adc_tvalid_0_1 [get_bd_ports adc_tvalid_0] [get_bd_pins dsp_data_source_mux_0/adc_tvalid]
  connect_bd_net -net axi_slave_reg_0_data_source_selector [get_bd_pins data_source_register/data_source_selector] [get_bd_pins dsp_data_source_mux_0/control_in]
  connect_bd_net -net subarray_creator_0_tdata_out [get_bd_pins Channel_filter/s_axis_data_tdata] [get_bd_pins subarray_creator_0/tdata_out]
  connect_bd_net -net subarray_creator_0_tvalid_out [get_bd_pins Channel_filter/s_axis_data_tvalid] [get_bd_pins subarray_creator_0/tvalid_out]
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"0.319628",
   "Default View_TopLeft":"-160,-294",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r6  2020-01-29 bk=1.5227 VDI=41 GEI=36 GUI=JA:10.0 non-TLS
#  -string -flagsOSRD
preplace port M_AXIS_DATA_0 -pg 1 -lvl 11 -x 3020 -y 530 -defaultsOSRD
preplace port adc_tvalid_0 -pg 1 -lvl 0 -x 0 -y 170 -defaultsOSRD
preplace portBus adc_tdata_0 -pg 1 -lvl 0 -x 0 -y 140 -defaultsOSRD
preplace inst axi_interconnect_0 -pg 1 -lvl 2 -x 370 -y 290 -defaultsOSRD
preplace inst Axi_clk -pg 1 -lvl 1 -x 120 -y 70 -defaultsOSRD
preplace inst adc_derived_clk -pg 1 -lvl 1 -x 120 -y 520 -defaultsOSRD
preplace inst Band_mixer -pg 1 -lvl 6 -x 1600 -y 490 -defaultsOSRD
preplace inst Band_filter -pg 1 -lvl 7 -x 1880 -y 500 -defaultsOSRD
preplace inst Channel_mixer -pg 1 -lvl 8 -x 2190 -y 520 -defaultsOSRD
preplace inst data_source_register -pg 1 -lvl 3 -x 710 -y 310 -defaultsOSRD
preplace inst Channel_filter -pg 1 -lvl 10 -x 2830 -y 530 -defaultsOSRD
preplace inst subarray_creator_0 -pg 1 -lvl 9 -x 2510 -y 530 -defaultsOSRD
preplace inst Band_selector_oscillator_controller -pg 1 -lvl 5 -x 1330 -y 620 -defaultsOSRD
preplace inst Band_selector_oscillator -pg 1 -lvl 4 -x 1050 -y 600 -defaultsOSRD
preplace inst basic_counter_0 -pg 1 -lvl 3 -x 710 -y 630 -defaultsOSRD
preplace inst Channel_selector_oscillator_controller -pg 1 -lvl 7 -x 1880 -y 650 -defaultsOSRD
preplace inst Channel_selector_oscillator -pg 1 -lvl 6 -x 1600 -y 630 -defaultsOSRD
preplace inst zero_padder_0 -pg 1 -lvl 5 -x 1330 -y 470 -defaultsOSRD
preplace inst dsp_data_source_mux_0 -pg 1 -lvl 4 -x 1050 -y 450 -defaultsOSRD
preplace inst Oscillator_controller -pg 1 -lvl 3 -x 710 -y 480 -defaultsOSRD
preplace inst Local_oscillator -pg 1 -lvl 2 -x 370 -y 460 -defaultsOSRD
preplace netloc Axi_clk_sync_rst 1 1 2 220 130 530
preplace netloc Axi_clk_clk 1 1 2 230 120 540
preplace netloc adc_derived_clk_clk 1 1 9 230 520 520 560 880 660 1200 700 1470 690 1730 570 2030 600 NJ 600 2660
preplace netloc adc_derived_clk_sync_rst 1 1 6 N 530 540 700 NJ 700 1190 710 NJ 710 1740J
preplace netloc axi_slave_reg_0_data_source_selector 1 3 1 900 310n
preplace netloc Channel_mixer_m_axis_dout_tdata 1 8 1 N 520
preplace netloc Channel_mixer_m_axis_dout_tvalid 1 8 1 N 540
preplace netloc subarray_creator_0_tdata_out 1 9 1 N 520
preplace netloc subarray_creator_0_tvalid_out 1 9 1 N 540
preplace netloc adc_tdata_0_1 1 0 4 NJ 140 NJ 140 520J 390 910J
preplace netloc adc_tvalid_0_1 1 0 4 NJ 170 NJ 170 510J 400 890J
preplace netloc Oscillator_controller_m_axis 1 3 1 N 480
preplace netloc basic_counter_0_m_axis 1 3 1 890 460n
preplace netloc Channel_filter_M_AXIS_DATA 1 10 1 N 530
preplace netloc Oscilador_local_M_AXIS_DATA_2 1 2 1 NJ 460
preplace netloc zero_padder_0_m_axis_out 1 5 1 N 470
preplace netloc Band_filter_M_AXIS_DATA 1 7 1 N 500
preplace netloc Band_selector_m_axis 1 5 1 1460 490n
preplace netloc Channel_selector_m_axis 1 7 1 2020 520n
preplace netloc dsp_data_source_mux_0_m_axis 1 4 1 N 450
preplace netloc Oscilador_local_M_AXIS_DATA_1 1 6 1 NJ 630
preplace netloc Band_mixer_M_AXIS_DOUT 1 6 1 N 490
preplace netloc axi_interconnect_0_M00_AXI 1 2 1 N 290
preplace netloc Oscilador_local_M_AXIS_DATA 1 4 1 NJ 600
levelinfo -pg 1 0 120 370 710 1050 1330 1600 1880 2190 2510 2830 3020
pagesize -pg 1 -db -bbox -sgen -160 0 3180 730
"
}
