...
\figura[0.7]{threading}{Ilustración de la implementación de \textit{threading} en Python (izq.) y en C++ (der.)\cite{threading-foto}.}[Ilustración de la implementación de \textit{threading} en Python (izq.) y en C++ (der.).]

\figura[0.8]{gil-dynamics}{Manejo del GIL entre varios \textit{threads}\cite{GIL-foto}.}[Manejo del GIL entre varios \textit{threads}.]
...
\figura{compilation-flow}{Flujo de compilación de un programa de C\cite{computer-systems}.}[Flujo de compilación de un programa de C.]
