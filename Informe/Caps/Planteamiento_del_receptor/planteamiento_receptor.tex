...
El receptor de la estación terrena se diseñará para la recepción de señales de satélites LEO en la banda amateur para servicios satelitales de UHF, que abarca desde los 435~MHz hasta los 438~MHz~\cite[p. 17]{itu-banda-amateur}. Dentro de esta banda, los satélites emiten en canales o \textit{beams} de alrededor 25~kHz de ancho de banda. \change{Agregar referencia? Update: no encuentro :/}
...
\figura[0.7]{array-grigo}{Arreglo de 16 elementos considerado para este proyecto \cite{proyecto-grigo}.}[Arreglo de 16 elementos considerado para este proyecto.]
...
\figura[0.7]{ADC}{Conversor analógico digital AD9249 de Analog Devices \cite{AD9249}.}[Conversor analógico digital AD9249 de Analog Devices.]
...
\figura[0.5]{ciaa-acc}{Placa CIAA-ACC.}

\figura[0.8]{diagrama-ciaa}{Diagrama de bloques de la plataforma CIAA-ACC \cite{CIAA-ACC}.}[Diagrama de bloques de la plataforma CIAA-ACC.]
...
\figura[0.7]{zynq-7000-arch}{Arquitectura del Soc Zynq-7030\cite{zynq-7000}.}[Arquitectura del Soc Zynq-7030.]
...
% Este \textit{pipeline} ya fue implementado en \cite{proyecto-jose} con la excepción del punto 3, referido al preprocesamiento. Más adelante en este proyecto, en el capítulo \ref{cap::preproc}, se abordará este punto, diseñándose e implementandose en el hardware.
