...
\begin{enumerate}
    ...
    \begin{enumerate}
        \item La escritura de registros dentro de la FPGA para las diversas configuraciones desarrolladas en \todo{Donde? Cap? Sec?}.
...
La interacción con la CIAA-ACC desde una computadora externa se realiza mediante SSH como se explicó \todo{Donde? En el cap de preproc?}. Para incorporar esto dentro de la GUI es necesario resolver dos cuestiones:
\begin{enumerate}
