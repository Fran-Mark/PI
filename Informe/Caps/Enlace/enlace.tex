...
\todo{Hacer calculitos y grafiquitos usando lo de Lucas Gomez}
...
\unsure{Debería agregar ganancias a amplificadores y longitudes a cables?}
\unsure{JQ: está medio confuso de seguir este diagrama. Habría que pensar en hacerlo netamente horizontal, o netamente vertical.}
...
Empleando \textit{full scale} como $1~V_\textrm{pp}$\unsure{JQ: por qué?}, se tiene que 
$$0\un{dBFS} \approx 4\un{dBm},$$ 
\unsure{Hace falta que explique de donde sale? \\ JQ: no está de más} 
...
\end{equation}
En la figura \ref{fig::degradacion-bt} se muestra la degradación de la BER en función del producto $B T_b$ ($W T_b$ en \change{JQ: mismo comentario que arriba sobre inglés vs español}).
